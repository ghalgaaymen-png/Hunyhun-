...
<head>
    ...
    <title>Website to Your Love</title>
    ...
    <style>
        ...
        /* Custom Image Styles - Applied to all images */
        .love-image {
            max-width: 100%;
            height: auto;
            border-radius: 10px;
        ...
        .anime-scene {
            ...
            overflow: hidden;
            border-radius: 15px;
            background: linear-gradient(180deg, #e0f2ff 0%, #87ceeb 30%, #4a90e2 60%, #87ceeb 100%);
        }
